  ...
  return (
    <>
      ...
      <Dialog
        ...
        closeLabel={tc("close")}
        labelledBy="new-promotion-title"
        className="sheet-panel relative max-h-[90dvh] w-full max-w-lg overflow-y-auto rounded-t-2xl bg-white p-5 shadow-xl sm:rounded-2xl"
      >
        <h2 id="new-promotion-title" className="text-lg font-bold text-zinc-900">{t("addPromo")}</h2>
